...
trap 'exit 143' TERM
npm run build
node --test scripts/test-organizer.mjs scripts/test-overview.mjs scripts/test-conversations.mjs scripts/test-timeline.mjs scripts/test-client-connection.mjs scripts/test-work-terminal.mjs
